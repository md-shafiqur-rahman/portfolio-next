        ...
        <>
            ...
            <div className="container">
                ...
                <div className="post-share">
                    ...
                    <a
                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(`https://shafiqur.dev/blog/${slug}`)}`}
                        target="_blank"
                        rel="noopener"
                        className="share-btn"
                        title="Share on X"
                    ...
                    <a
                        href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://shafiqur.dev/blog/${slug}`)}`}
                        target="_blank"
                        rel="noopener"
                        className="share-btn"
                    ...
                    <a
                        href={`https://api.whatsapp.com/send?text=${encodeURIComponent(post.title + " " + `https://shafiqur.dev/blog/${slug}`)}`}
                        target="_blank"
                        rel="noopener"
                        className="share-btn"
